...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them? - ` Describe breaks up the test suite in components and it performs the individual tests`-

1. What is the point of `Test Driven Development`? What do you think about this approach? -`TDD allows the programmer to break the negative feedback loop and maintain a constant cost of change.`-


1. Mention three types of automated tests. _`Unit testing, Integration testing, and Component testing.`_
